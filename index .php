...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header">
      <a class="navbar-brand text-dark" href="#myPage"><strong>Nagaraj</strong></a>
    </div>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
                  ...
                  <li><a href="Users/login.php">Patients</a></li>
            	<li><a href="Admin/adminlogin.php">Admin</a></li>
                  </ul>
          </li>
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#location">Hospital Address <span class="caret"></span></a>
          <ul class="dropdown-menu"> 
       <li> <a href="location map/dhaka.html">Davangere</a></li>
      <li>  <a href='location map/chittagong.html'>Harihar</a></li>
    ...
    <li>  <a href='dentist.php'>Dentist</a></li>
     ...
     <li>  <a href='gynecologist.php'>Gynecologist</a></li>
        ...
        <li><a href="chat with us/chat.php">Chat with us</a></li>  
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="pic/15287983165.jpg" alt="img1" width="1200" height="700">

      </div>

      <div class="item">
        <img src="pic/15287983165.jpg" alt="img2" width="1200" height="700">
...
<div id="#" class="bg-1">
  <div class="container">
    ...
    <h3 class="text-center">DOCTALK</h3>
  ...
  <div class="w3-container w3-content w3-padding-64" style="max-width:800px"  id="contact">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-col m6 w3-large w3-margin-bottom">
        <i class="fa fa-map-marker" style="width:30px"></i>Davangere,Karnataka,India<br>
        <i class="fa fa-phone" style="width:30px"></i> Phone: +91......<br>
        <i class="fa fa-envelope" style="width:30px"> </i> Email: davidtellis12@gmail.com<br>
      </div>
      <?php
...
<footer class="text-center">
  ...
  <p><a href="http://labaidgroup.com/specialized/doctor" data-toggle="tooltip" title="DOCTALK">@doctalk</a></p> 
</footer>
<script>
